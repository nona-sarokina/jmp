...
public class PostDAOImpl extends AbstractDAOImpl<Post> {
    protected static final String CREATE_TABLE_QUERY = "CREATE TABLE IF NOT EXISTS posts ( id INT AUTO_INCREMENT PRIMARY KEY, userID int NOT NULL, text LONGTEXT NOT NULL, timest TIMESTAMP NOT NULL, CONSTRAINT posts_user__fk FOREIGN KEY (userID) REFERENCES User (id));";
