...
public class UserDAOImpl extends AbstractDAOImpl<User> {
    protected static final String CREATE_TABLE_QUERY = "CREATE TABLE IF NOT EXISTS  user (id INT AUTO_INCREMENT PRIMARY KEY, name VARCHAR(50) NOT NULL, surname VARCHAR(50) NOT NULL, birthdate DATE NOT NULL,  PRIMARY KEY (id));";
    protected static final String INSERT_QUERY = "INSERT INTO user (NAME, SURNAME, BIRTHDATE) VALUES (?, ?, ?)";
    protected static final String SELECT_QUERY = "SELECT * FROM user";
